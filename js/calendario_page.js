/* ================================================================
   calendario_page.js — Calendário de reservas (todas as roles)
   ================================================================ */
...
(function() {
  ...
  function _seg(d) {          // início da semana na segunda
    var dt = new Date(d); dt.setHours(0,0,0,0);
    var dow = dt.getDay();    // 0=dom
  ...
  function _tcl(turno) {        // class CSS do turno
    if (!turno) return 'mat';
  ...
  function _mes() {
    ...
    try {
      ...
      var sdow  = prim.getDay();                           // 0=dom
      var off   = (sdow === 0) ? 6 : sdow - 1;            // offset segunda-first
  ...
  function _sem() {
    ...
    try {
      ...
      dias.forEach(function(d) {
        ...
        var dowIdx = (d.getDay() === 0) ? 6 : d.getDay() - 1;  // Mon=0
  ...
  // Aliases para compatibilidade com HTML antigo
