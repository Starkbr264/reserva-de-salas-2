 ...
 *   Chaves, Solicitacoes, Notificacoes
 *
 * Funcoes utilitarias exportadas:
 *   fmtData, calcStatus, labelStatus, esc, iniciais,
 *   toast, fmsg, modalAbrir, modalFechar, initTema, toggleTema
 */
...
// Cache em memoria (espelho do localStorage)
const CACHE = {
...
// Carrega dados do localStorage para o cache
function _load() {
...
function _seedDados() {
  ...
  const salas = [
    ...
    { id:5033, nome:'Lab Informatica 02', capacidade:28, tipo:'Laboratorio de Informatica', andar:'2º Andar', bloco:'Bloco B', turnosDisponiveis:['Matutino','Vespertino','Noturno'], unidadeId:1002, statusManual:null },
    { id:5034, nome:'Sala Multiuso 01', capacidade:32, tipo:'Sala Multiuso', andar:'1º Andar', bloco:'Bloco C', turnosDisponiveis:['Vespertino','Noturno'], unidadeId:1002, statusManual:null },
    { id:5035, nome:'Lab Fotografia 01', capacidade:18, tipo:'Estudio de Fotografia', andar:'1º Andar', bloco:'Bloco C', turnosDisponiveis:['Matutino','Vespertino'], unidadeId:1003, statusManual:null },
    ...
    { id:5037, nome:'Lab Redes 01', capacidade:24, tipo:'Laboratorio de Redes', andar:'2º Andar', bloco:'Bloco B', turnosDisponiveis:['Matutino','Vespertino','Noturno'], unidadeId:1004, statusManual:null },
    { id:5038, nome:'Sala Idiomas 01', capacidade:30, tipo:'Sala de Idiomas', andar:'1º Andar', bloco:'Bloco A', turnosDisponiveis:['Matutino','Vespertino'], unidadeId:1004, statusManual:null },
    ...
    { id:5040, nome:'Sala Empreender 01', capacidade:28, tipo:'Sala Comum', andar:'2º Andar', bloco:'Bloco C', turnosDisponiveis:['Vespertino','Noturno'], unidadeId:1005, statusManual:null },
    { id:5041, nome:'Lab Beleza 02', capacidade:18, tipo:'Laboratorio de Estetica', andar:'1º Andar', bloco:'Bloco B', turnosDisponiveis:['Matutino','Vespertino'], unidadeId:1006, statusManual:null },
    { id:5042, nome:'Sala Informatizada 02', capacidade:32, tipo:'Laboratorio de Informatica', andar:'2º Andar', bloco:'Bloco C', turnosDisponiveis:['Matutino','Vespertino','Noturno'], unidadeId:1006, statusManual:null },
    { id:5043, nome:'Lab Saude 02', capacidade:22, tipo:'Laboratorio de Enfermagem', andar:'1º Andar', bloco:'Bloco C', turnosDisponiveis:['Matutino','Vespertino'], unidadeId:1007, statusManual:null },
    { id:5044, nome:'Sala Projetos 01', capacidade:28, tipo:'Sala Colaborativa', andar:'2º Andar', bloco:'Bloco A', turnosDisponiveis:['Vespertino','Noturno'], unidadeId:1007, statusManual:null },
    { id:5045, nome:'Lab Games 01', capacidade:24, tipo:'Laboratorio de Informatica', andar:'2º Andar', bloco:'Bloco C', turnosDisponiveis:['Matutino','Vespertino','Noturno'], unidadeId:1008, statusManual:null },
    ...
    { id:5047, nome:'Lab Beleza 02', capacidade:18, tipo:'Laboratorio de Estetica', andar:'2º Andar', bloco:'Bloco A', turnosDisponiveis:['Matutino','Vespertino'], unidadeId:1009, statusManual:'bloqueada', motivoManual:'Limpeza tecnica agendada', manualPor:'Isabela Ramos', manualCriadaEm:new Date(Date.now()-43200000).toISOString().slice(0, 19) },
    { id:5048, nome:'Sala Digital 01', capacidade:30, tipo:'Laboratorio de Informatica', andar:'1º Andar', bloco:'Bloco C', turnosDisponiveis:['Matutino','Noturno'], unidadeId:1009, statusManual:null },
    { id:5049, nome:'Lab Marketing 01', capacidade:26, tipo:'Laboratorio Criativo', andar:'2º Andar', bloco:'Bloco C', turnosDisponiveis:['Matutino','Vespertino'], unidadeId:1010, statusManual:null },
    { id:5050, nome:'Sala Mentoria 01', capacidade:14, tipo:'Sala de Reuniao', andar:'1º Andar', bloco:'Bloco B', turnosDisponiveis:['Matutino','Vespertino','Noturno'], unidadeId:1010, statusManual:null },
  ];
